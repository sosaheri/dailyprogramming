...
function pageCount($n, $p) {
    ...
    if( checkSide($list, $p , 'forward') < checkSide($list, $p , 'backforward')){
        return checkSide($list, $p , 'forward')."\n";
    }else {
        return checkSide($list, $p , 'backforward')."\n";
    }

    
}

function checkSide($list, $p ,$direction){
